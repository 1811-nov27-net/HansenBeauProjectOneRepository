...
namespace ProjectOne
{
    public class ManualMapper
    {
        ...
        // Models/ Library mappings for Address classes
        public static Models.Address ManMap2(Library.Address address) => new Models.Address
        {
            AddressId = address.AddressId,
            AddressLine1 = address.AddressLine1,
            AddressLine2 = address.AddressLine2,
        ...
        public static Library.Address ManMap2(Models.Address address) => new Library.Address
        {
            AddressId = address.AddressId,
            AddressLine1 = address.AddressLine1,
            AddressLine2 = address.AddressLine2,
        ...
        // 
        public static IEnumerable<Library.Address> ManMap2(IEnumerable<Models.Address> address) => address.Select(ManMap2);
        public static IEnumerable<Models.Address> ManMap2(IEnumerable<Library.Address> address) => address.Select(ManMap2);
        ...
        public static Library.Product ManMap2(Models.Product product) => new Library.Product
        {
            ProductID = product.ProductId,
            ProductName = product.ProductName,
            UnitPrice = product.UnitPrice,
        };
        public static Models.Product ManMap2(Library.Product product) => new Models.Product
        {
            ProductId = product.ProductID,
            ProductName = product.ProductName,
            UnitPrice = product.UnitPrice,
        };
        public static IEnumerable<Library.Product> ManMap2(IEnumerable<Models.Product> product) => product.Select(ManMap2);
        public static IEnumerable<Models.Product> ManMap2(IEnumerable<Library.Product> product) => product.Select(ManMap2);
        ...
        public static Library.Store ManMap2(Models.Store store) => new Library.Store
        {
            StoreID = store.StoreID,
            AddressLine1 = store.AddressLine1,
            AddressLine2 = store.AddressLine2,
        ...
        public static IEnumerable<Library.Store> ManMap2(IEnumerable<Models.Store> store) => store.Select(ManMap2);
        public static IEnumerable<Models.Store> ManMap2(IEnumerable<Library.Store> store) => store.Select(ManMap2);
    }
}
